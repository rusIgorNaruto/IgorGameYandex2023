...
if __name__ == '__main__':
    ...
    pygame.init()
    wi = pygame.display.set_mode((1000, 600))

    slider = Slider(wi, 100, 100, 800, 40, min=0, max=99, step=1)
    output = TextBox(wi, 475, 200, 50, 50, fontSize=30)

    v_slider = Slider(wi, 900, 200, 40, 300, min=0, max=99, step=1, vertical=True)
    v_output = TextBox(wi, 800, 320, 50, 50, fontSize=30)
