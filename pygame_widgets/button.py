...
if __name__ == '__main__':
    pygame.init()
    wi = pygame.display.set_mode((600, 600))

    button = Button(wi, 100, 100, 300, 150, text='Hello', fontSize=50, margin=20,
    ...
    buttonArray = ButtonArray(wi, 50, 50, 500, 500, (2, 2), border=100, texts=('1', '2', '3', '4'),
